...
class TopicModelingClass:
	def __init__(self, docs, algorithms_used):
		self.docs = docs
	...
	def display_topics(self, model, feature_names, best_no_topics):
	...
	def apply_nmf_on_articles(self):
		for doc in self.docs:
			...
			self.display_topics(nmf, tfidf_feature_names, None)
			print("\n\n\n")
	...
	def apply_lda_on_articles(self):
		for doc in self.docs:
			...
			self.display_topics(lda, tf_feature_names, None)
			print("\n\n\n")
	...
	def apply_enhanced_lda_on_articles(self):
		for doc in self.docs:
			...
			self.display_topics(best_lda, tf_feature_names, nt)
			print("\n\n\n")
	...
	def apply_lsa_on_articles(self):
		for doc in self.docs:
			...
			self.display_topics(svd, tf_feature_names, None)
			print("\n\n\n")
